...
_CRM_CATEGORY_HINTS = {
    ...
    "lead_routing": (
        ...
        "Hardcode the exact conditions from the question text as if/elif: "
        ...
        "  'in' check: lead.get('Region') in ('APAC', 'EMEA'). "
        "if <condition1>: print('<Team Name from question>'). "
        "elif <condition2>: print('<Team Name from question>'). "
        "else: print(None). "
    ...
    "case_routing": (
        ...
        "  'in' check: case.get('Region') in ('APAC', 'EMEA'). "
        "if <condition1>: print('<Queue Name from question>'). "
        "elif <condition2>: print('<Queue Name from question>'). "
        "else: print(None). "
    ...
    "conversion_rate_comprehension": (
        ...
        "    v=float(data[0].get(_rf)); print(round(v*100,2) if v < 1.0 else round(v,2)). "
    ...
    "best_region_identification": (
        ...
        "    c=Counter(r.get(_rf) for r in data if r.get(_rf)); print(c.most_common(1)[0][0] if c else None). "
    ...
    "sales_insight_mining": (
        ...
        "  for r in data: k=r.get(_gf); v=r.get(_af); "
        ...
        "  c = Counter(r.get(_gf) for r in data if r.get(_gf)); print(c.most_common(1)[0][0] if c else None). "
